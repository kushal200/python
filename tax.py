...
print(f"Tax Payee: {name}\t\t\t\tAddress: {address}")
print(f"PAN No. {pan}\t\tFY: 2020/21\t\t\tMarried Status = {status}")
print(f"Tax Payee {name} with PAN {pan} fall under ({tax})% Tax salb.")
print(f"{name} (PAN {pan}) to pay tax to government is [Rs.]= {total}")